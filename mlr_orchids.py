...
df_day_1 = pd.read_csv("round-2-island-data-bottle\\prices_round_2_day_1.csv", delimiter=";")
...
df_day_0['prevHUMIDITY'] = df_day_0['HUMIDITY'].shift(1)
...
df_day_1['prevHUMIDITY'] = df_day_1['HUMIDITY'].shift(1)
...
df_combined = pd.concat([df_day_0, df_day_1, df_day_1])
df_combined
