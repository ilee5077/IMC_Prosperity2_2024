...
class Trader:
    ...
    def next_orchid_price(self, state: TradingState, mydata):
        ...
        nxt_price = (best_buy_pr+best_sell_pr)/2
    ...
    def compute_orders_basket(self, order_depth, state: TradingState, POSITION_LIMIT, mydata):
        ...
        res_buy_cc = mid_price['CHOCOLATE'] - ((mid_price['GIFT_BASKET'] - 379.5 - 6*mid_price['STRAWBERRIES'] - mid_price['ROSES'])/4  - 94.873)
        res_sell_cc = mid_price['CHOCOLATE'] - ((mid_price['GIFT_BASKET'] - 379.5 - 6*mid_price['STRAWBERRIES'] - mid_price['ROSES'])/4 - 94.873)
        
        trade_at_cc = 19.106*0.5

        res_buy_sb = mid_price['STRAWBERRIES'] - ((mid_price['GIFT_BASKET'] - 379.5 - mid_price['CHOCOLATE']*4 - mid_price['ROSES'])/6  - 63.248)
        res_sell_sb = mid_price['STRAWBERRIES'] - ((mid_price['GIFT_BASKET'] - 379.5 - mid_price['CHOCOLATE']*4 - mid_price['ROSES'])/6 - 63.248)
        
        trade_at_sb = 12.737*0.6

        res_buy_rs = mid_price['ROSES'] - ((mid_price['GIFT_BASKET'] - 379.5 - mid_price['CHOCOLATE']*4 - 6*mid_price['STRAWBERRIES'])  - 379.5)
        res_sell_rs = mid_price['ROSES'] - ((mid_price['GIFT_BASKET'] - 379.5 - mid_price['CHOCOLATE']*4 - 6*mid_price['STRAWBERRIES']) - 379.5)
        
        trade_at_rs = 76.4*0.5
